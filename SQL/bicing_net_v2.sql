...
CREATE TABLE IF NOT EXISTS `BICING_PRAC`.`tipus_SUBSCRIPCIONS` (
  ...
  `precio_por_MEDIA_hora` VARCHAR(45) NULL,
  `precio_hora_extra` VARCHAR(45) NULL,
  `TIEMPO_GRATIS` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `DOCK` ( 
    ...
    `bicicleta_idBICICLETA` INT NULL, PRIMARY KEY (`idDock`), 
...
CREATE TABLE IF NOT EXISTS `BICING_PRAC`.`TRAJECTE` (
  ...
  `dock_final_lliure` TINYINT NULL DEFAULT 1,
  `id_EST_origen` INT NOT NULL,
  `id_EST_fin` INT DEFAULT NULL ,
  `BICICLETA_idBICICLETA` INT NOT NULL,
  `BICICLETA_ESTACIO_idESTACIO` INT NOT NULL,
  `USUARI_idUSUARI` INT NOT NULL,
  PRIMARY KEY (`idTRAJECTE`, `id_EST_origen`, `id_EST_fin`, `BICICLETA_idBICICLETA`, `BICICLETA_ESTACIO_idESTACIO`, `USUARI_idUSUARI`),
...
CREATE TABLE IF NOT EXISTS `BICING_PRAC`.`INCIDENT_feedback` (
  ...
  `roda` TINYINT NOT NULL DEFAULT 0 COMMENT 'esata',
  ...
  INDEX `fk_INCIDENT_feedback_TRAJECTE1_idx` (`TRAJECTE_idTRAJECTE` ASC, `TRAJECTE_id_EST_origen` ASC, `TRAJECTE_id_EST_fin` ASC, `TRAJECTE_BICICLETA_idBICICLETA` ASC, `TRAJECTE_BICICLETA_ESTACIO_idESTACIO` ASC),
