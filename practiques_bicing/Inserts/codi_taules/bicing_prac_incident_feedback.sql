...
CREATE TABLE `incident_feedback` (
  ...
  KEY `fk_INCIDENT_feedback_TRAJECTE1_idx` (`TRAJECTE_idTRAJECTE`,`TRAJECTE_id_EST_origen`,`TRAJECTE_id_EST_fin`,`TRAJECTE_BICICLETA_idBICICLETA`,`TRAJECTE_BICICLETA_ESTACIO_idESTACIO`)
